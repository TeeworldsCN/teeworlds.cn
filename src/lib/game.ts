...
export const TARGETS = [
	// R1~R4 是教学与地基;R5 的台阶从 950 压到 750(实测这里是最陡的相对跳变),之后 18% 复利。
	// 原因(模拟器实测):原来的曲线(R16=12200)把中盘抬得太高,靠"攒资源/攒关卡"
	// 成长的流派(经济/成长/负分)在第 5~8 关就被砍断,根本走不到自己的收益期。
	// 现在所有流派在**最优打法**下都能打到 R16,难度体现为「次优/随机能走多远」。
