...
export type TeeEffect =
	...
	| { type: 'mult'; value: number } // 倍率增长 ×mult
	...
	// 不是「倍率增长 ×2」——只放大这几个等级自带的基础分,不动后面的倍率链
	...
	// 连号长度倍率:连号 n 颗 → 倍率增长 ×per^(n-from)。连号流的引擎 ——
	...
	// 云海:掷完可发动,立刻结束本关;每个还没投掷的角色各给 perTee 月饼币
	...
	| { type: 'coin_mult'; perCoin: number; per: number } // 每 perCoin 月饼币:倍率增长 ×per
	| { type: 'growth_mult'; per: number } // 每过一关:倍率增长 ×(1+per)(复利,读 growth)
	| { type: 'relay_left'; share: number } // 加算:左侧相邻 Tee 的已结算倍率增长 ×share
	| { type: 'sum_mult'; from: number; per: number } // 和值每超过 from 一点:倍率增长 ×per
	...
	// 星河:按「我」**作废**的骰子数,把「我」自己的倍率增长 ×per×作废颗数(唯一真的把倍率给「我」的一张)
	...
	| { type: 'buff_refund' }
	// 夜市饼摊:上回合卖出过 Tee → 本回合该 Tee 倍率增长 ×mult(不累积、不限次数)
	...
	// 高照:本回合**首个投掷者**的最终骰面 → 其他 Tee 回合内首次投掷的点数
	// (判定在页面侧:换人开掷时拿 team[0].lastDice 当下发牌面)
	| { type: 'shared_first_roll' } // 只有高照带这条;文案点名的四张是「谁先投谁当模板」
...
export const CARDS: TeeCard[] = [
	...
	},
	{
		id: 'jinshi',
		name: '进士',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×3',
		rarity: 'common',
		skin: 'Scholar',
	...
	},
	{
		id: 'denglong',
		name: '高照',
		desc: '「高照」在队伍中时：「高照」「串珠」「七星灯」「连珠灯」里首先投掷的那个 Tee，其最终点数与作废状态决定其他 Tee 回合内首次投掷的骰子；重掷后回到本关正常的作废规则',
		rarity: 'common',
		skin: 'red_flame',
	...
	},
	{
		id: 'huadeng',
		name: '喜钱',
		desc: '掷完可发动：消耗 10 月饼币，该 Tee 倍率增长 ×2.5（冷却 2 关）',
		rarity: 'common',
		skin: 'cutee_glow',
		effect: { type: 'active', skill: 'mult', mult: 2.5, cost: 10, cooldown: 2 }
	},
	{
		id: 'dengmi',
		name: '猜谜',
	...
	},
	{
		id: 'guiying',
		name: '桂影',
		desc: '回合结算时：右邻本关得分的 30% + 60 分加进全队分，自己的倍率增长 ×1.3',
		rarity: 'common',
		skin: 'Green',
		tag: '桂',
		effect: {
	...
	},
	{
		id: 'bingdilian',
		name: '并蒂莲',
		desc: '回合结算时：左右两人本关得分的 45% + 100 分加进全队分，自己的倍率增长 ×1.35',
		rarity: 'rare',
	...
	},
	{
		id: 'wangyuehuaiyuan',
		name: '望月怀远',
		desc: '「我」掷出"三红"及以上时，该 Tee 倍率增长 ×4.5',
		rarity: 'rare',
		tag: '月',
		skin: 'lunalovegood',
	...
	},
	{
		id: 'yuexialaoren',
		name: '月下老人',
		desc: '回合结算时：左右两人本关得分的 75% + 150 分加进全队分，自己的倍率增长 ×1.45',
		rarity: 'legendary',
		skin: 'OLD Tee',
		tag: '月',
		effect: {
	...
	},
	{
		id: 'yuebingshijia',
		name: '饼香世家',
		desc: '每拥有一个独特的「饼」系角色，该 Tee 倍率增长 ×2.2',
		rarity: 'legendary',
		skin: 'cupcakecherry',
		tag: '饼',
	...
	},
	{
		id: 'lianzhudeng',
		name: '连珠灯',
		desc: '投掷后可发动：把 1 颗骰子改为 4 点，冷却 2 关；投掷后可将任意数量的 4 点骰子改为任意点数；掷出对堂：基础分 +150，倍率增长 ×2',
		rarity: 'rare',
		tag: '灯',
	...
	},
	{
		id: 'qixingdeng',
		name: '七星灯',
		desc: '连号里每颗骰子：基础分 +70；连号每多 1 颗，倍率增长 ×2',
		rarity: 'rare',
		tag: '灯',
	...
	},
	{
		id: 'houyi',
		name: '射日仙',
		desc: '再接再厉时自动重掷全部（每回合 1 次）；本回合每重掷 1 颗骰子：倍率增长 ×1.35',
		rarity: 'rare',
		tag: '仙',
		skin: 'Yellow',
		effect: {
			...
			parts: [
				...
				// 作用在基础分侧:能和道具的得分倍率叠着爆(倍率增长 ×2 那半段已去掉)。
	...
	},
	{
		id: 'quanjiafu',
		name: '合家福饼',
		desc: '队伍每多 1 人：倍率增长 ×1.5；满 6 人再 ×2',
		rarity: 'legendary',
		tag: '饼',
		skin: 'Red and White',
	...
	},
	{
		id: 'yutuyao',
		name: '玉兔捣药',
		desc: '未掷出再接再厉时：判定等级 +1 档，但倍率增长 ×0.8；状元插金花：基础分倍率增长 ×2',
		rarity: 'rare',
		tag: '兔',
		skin: 'rabbit_new2',
		effect: {
	...
	},
	{
		id: 'yinhe',
		name: '星河',
		desc: '「我」掷出的 4 点作废；「我」每有 1 颗作废骰子，倍率增长 ×2.3；该 Tee 基础分 +30',
		rarity: 'rare',
		skin: 'astronaut',
		effect: {
			type: 'bundle',
	...
	},
	{
		id: 'yunhai',
		name: '云海',
		desc: '掷完可发动：立刻结束本关，每个尚未投掷的角色 +5 月饼币（冷却 2 关）',
		rarity: 'rare',
		skin: 'cloudly',
	...
	},
	{
		id: 'guanghan',
		name: '月上广寒',
		desc: '该 Tee 基础分 +200，掷出的 1、6 视为 4；回合结算时：总分额外 +（「我」的倍率增长 × 左侧 Tee 得分 ÷ 该 Tee 得分）',
		rarity: 'rare',
		tag: '月',
		skin: 'IceWitch',
		effect: {
	...
	},
	{
		id: 'jinghuashuiyue',
		name: '镜花仙缘',
		desc: '复制右侧 Tee 的卡牌，且全队总分倍率增长 ×1.25',
		rarity: 'legendary',
		tag: '仙',
	...
	},
	{
		id: 'panlong',
		name: '蟠龙礼盒',
		desc: '全队总分倍率增长 ×1.3，每关 +4 月饼币；每 10 月饼币：该 Tee 倍率增长 ×1.2',
		rarity: 'legendary',
		skin: 'ghost_dragon',
		effect: {
			type: 'bundle',
	...
	//   base 按点数钉死:1/6 点 42、2/5 点 44、3 点 45(旧的 30/120/420/1600/3700/8400
	{
		id: 'hanxing',
		name: '寒星',
		desc: '自己每有 1 颗 1 点：基础分 +142、倍率增长 ×1.4',
		rarity: 'rare',
		skin: 'IceWitch_Dark',
		effect: { type: 'own_face', face: 1, chips: 142, mult: 1.4 }
	},
	{
		id: 'shuangli',
		name: '双鲤衔饼',
		desc: '自己每有 1 颗 2 点：基础分 +144、倍率增长 ×1.4',
		rarity: 'rare',
		tag: '饼',
		skin: 'Aqua Fish_KZ',
		effect: { type: 'own_face', face: 2, chips: 144, mult: 1.4 }
	},
	{
		id: 'sanqiu',
		name: '灯下三秋',
		desc: '自己每有 1 颗 3 点：基础分 +145、倍率增长 ×1.4',
		rarity: 'rare',
		tag: '灯',
		skin: 'glow_turtle',
		effect: { type: 'own_face', face: 3, chips: 145, mult: 1.4 }
	},
	{
		id: 'mantanghong',
		name: '满堂红',
	...
	},
	{
		id: 'wugeng',
		name: '五更桂花',
		desc: '自己每有 1 颗 5 点：基础分 +144、倍率增长 ×1.4',
		rarity: 'rare',
		tag: '桂',
		skin: 'Greeny',
		effect: { type: 'own_face', face: 5, chips: 144, mult: 1.4 }
	},
	{
		id: 'liuhe',
		name: '六合仙踪',
		desc: '自己每有 1 颗 6 点：基础分 +142、倍率增长 ×1.4',
		rarity: 'rare',
		tag: '仙',
		skin: 'coala_phoenix',
		effect: { type: 'own_face', face: 6, chips: 142, mult: 1.4 }
	},
	...
	// ==== 点数线套装(传说档):每颗翻倍,橙卡是这套的终点 ====
	{
		id: 'yiyang',
		name: '纯阳仙',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×2；掷出 3 个同点数：基础分 +90；自己每有 1 颗 1 点：基础分 +20、倍率增长 ×2',
		rarity: 'legendary',
		tag: '仙',
		skin: 'clan_wheat',
		effect: {
	...
	},
	{
		id: 'shuangbi',
		name: '桂璧生辉',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×2；掷出 3 个同点数：基础分 +90；自己每有 1 颗 2 点：基础分 +20、倍率增长 ×2',
		rarity: 'legendary',
		tag: '桂',
	...
	},
	{
		id: 'sanqing',
		name: '三清仙尊',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×2；掷出 3 个同点数：基础分 +90；自己每有 1 颗 3 点：基础分 +20、倍率增长 ×2',
		rarity: 'legendary',
		tag: '仙',
		skin: 'IceWitch_Druid',
		effect: {
	...
	},
	{
		id: 'wuyue',
		name: '五岳桂香',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×2；掷出 3 个同点数：基础分 +90；自己每有 1 颗 5 点：基础分 +25、倍率增长 ×2',
		rarity: 'legendary',
		tag: '桂',
		skin: 'Green ray',
		effect: {
	...
	},
	{
		id: 'liulong',
		name: '六龙仙驭',
		desc: '四进、五子登科、六博黑：该等级的基础分倍率增长 ×2；掷出 3 个同点数：基础分 +90；自己每有 1 颗 6 点：基础分 +25、倍率增长 ×2',
		rarity: 'legendary',
		tag: '仙',
		skin: 'dragon 2',
		effect: {
	...
	// 5 张同流派时 ×(2^5)=32 → 一秀 (10+20)×32 = 960 > 状元 320。
	{
		id: 'yutuhui',
		name: '兔儿满堂',
		desc: '每拥有一个独特的「兔」系角色：该 Tee 倍率增长 ×1.8；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '兔',
		skin: 'BunnyViVi',
		effect: { type: 'per_tag', tag: '兔', per: 1.8, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'guiyuan',
		name: '桂苑',
		desc: '每拥有一个独特的「桂」系角色：该 Tee 倍率增长 ×1.4；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '桂',
		skin: 'flower_crown_ghost',
		effect: { type: 'per_tag', tag: '桂', per: 1.4, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'yuebingfang',
		name: '饼坊',
		desc: '每拥有一个独特的「饼」系角色：该 Tee 倍率增长 ×1.7；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '饼',
		skin: 'buni',
		effect: { type: 'per_tag', tag: '饼', per: 1.7, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'dengzhen',
		name: '灯阵',
		desc: '每拥有一个独特的「灯」系角色：该 Tee 倍率增长 ×1.5；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '灯',
		skin: 'glow_axolotl',
		effect: { type: 'per_tag', tag: '灯', per: 1.5, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'yuelun',
		name: '月轮',
		desc: '每拥有一个独特的「月」系角色：该 Tee 倍率增长 ×1.2；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '月',
		skin: 'cloud',
		effect: { type: 'per_tag', tag: '月', per: 1.2, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'xianlv',
		name: '仙侣',
		desc: '每拥有一个独特的「仙」系角色：该 Tee 倍率增长 ×1.6；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '仙',
		skin: 'cammostripeangel',
		effect: { type: 'per_tag', tag: '仙', per: 1.6, as: 'mult', chipsPerFour: 150 }
	},
	{
		id: 'yutulinfan',
		name: '玉兔临凡',
		desc: '每拥有一个独特的「兔」系角色：所有「兔」系 Tee 倍率增长 ×1.45；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '兔',
		skin: 'usagi',
		effect: { type: 'per_tag', tag: '兔', per: 1.45, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	{
		id: 'guidian',
		name: '桂殿',
		desc: '每拥有一个独特的「桂」系角色：所有「桂」系 Tee 倍率增长 ×1.2；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '桂',
		skin: 'ghost_greensward',
		effect: { type: 'per_tag', tag: '桂', per: 1.2, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	{
		id: 'tuanyuanbing',
		name: '团圆饼',
		desc: '每拥有一个独特的「饼」系角色：所有「饼」系 Tee 倍率增长 ×1.35；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '饼',
		skin: 'Mint Choco',
		effect: { type: 'per_tag', tag: '饼', per: 1.35, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	{
		id: 'changmingdeng',
		name: '长明灯',
		desc: '每拥有一个独特的「灯」系角色：所有「灯」系 Tee 倍率增长 ×1.25；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '灯',
		skin: 'glow_cammo',
		effect: { type: 'per_tag', tag: '灯', per: 1.25, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	{
		id: 'taiyin',
		name: '太阴素月',
		desc: '每拥有一个独特的「月」系角色：所有「月」系 Tee 倍率增长 ×1.15；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '月',
		skin: 'IceWitch_Queen',
		effect: { type: 'per_tag', tag: '月', per: 1.15, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	{
		id: 'qunxianhui',
		name: '群仙会',
		desc: '每拥有一个独特的「仙」系角色：所有「仙」系 Tee 倍率增长 ×1.3；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '仙',
		skin: 'Drag Queen',
		effect: { type: 'per_tag', tag: '仙', per: 1.3, as: 'mult', chipsPerFour: 300, teamWide: true }
	},
	// ==== 主 Tee 流:队友给「我」改骰子规则 ====
	//
	...
	// R6 之后每卖一个都变成永久倍率,所以是典型的后期流派(越晚越强)。
	{
		id: 'yeshi',
		name: '夜市饼摊',
		desc: '集市内若有卖出 Tee：下回合该 Tee 总分倍率增长 ×2',
		rarity: 'rare',
		tag: '饼',
		skin: 'Lan_Pudding',
	...
	},
	{
		id: 'dazhanggui',
		name: '饼铺掌柜',
		desc: '每累计卖出 1 个 Tee：该 Tee 基础分 +75；队伍里没有「我」时，回合结算队伍总分倍率增长 ×2',
		rarity: 'legendary',
		tag: '饼',
		skin: 'biscuit',
		effect: {
	...
	},
	{
		id: 'jinchan',
		name: '仙蟾',
		desc: '掷完可发动：该 Tee 总分倍率增长 ×2（冷却 3 关）',
		rarity: 'legendary',
		tag: '仙',
		skin: 'royal_turtle',
		effect: { type: 'active', skill: 'mult', mult: 2, cooldown: 3 }
	},
	{
		id: 'fagui',
		name: '伐桂',
