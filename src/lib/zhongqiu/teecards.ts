...
export const CARDS: TeeCard[] = [
	...
	},
	{
		id: 'huadeng',
		name: '喜钱',
		desc: '掷完可发动：消耗 10 月饼币，该 Tee 得分 ×2.5（冷却 2 关）',
		rarity: 'common',
		skin: 'cutee_glow',
	...
	},
	{
		id: 'bingdilian',
		name: '并蒂莲',
		desc: '回合结算时：左右两人本关得分的 45% + 100 分加进全队分，自己的得分 ×1.35',
		rarity: 'rare',
	...
	},
	{
		id: 'yuexialaoren',
		name: '月下老人',
		desc: '回合结算时：左右两人本关得分的 75% + 150 分加进全队分，自己的得分 ×1.45',
		rarity: 'legendary',
		skin: 'OLD Tee',
		tag: '月',
		effect: {
	...
	},
	{
		id: 'guanghangong',
		name: '月宫广寒',
		desc: '掷完可发动：该 Tee 总分得分 ×1.3；冷却 2 关',
		rarity: 'rare',
		tag: '月',
	...
	},
	{
		id: 'yinhe',
		name: '星河',
		desc: '「我」掷出的 4 点作废；「我」每有 1 颗作废骰子，得分 ×2.3；该 Tee 基础分 +30',
		rarity: 'rare',
		skin: 'astronaut',
		effect: {
			type: 'bundle',
	...
	},
	{
		id: 'dazhanggui',
		name: '饼铺掌柜',
		desc: '每累计卖出 1 个 Tee：该 Tee 基础分 +75；队伍里没有「我」时，回合结算队伍总分得分 ×2',
		rarity: 'legendary',
		tag: '饼',
		skin: 'biscuit',
		effect: {
	...
	},
	{
		id: 'jinchan',
		name: '仙蟾',
		desc: '掷完可发动：该 Tee 总分得分 ×2（冷却 3 关）',
		rarity: 'legendary',
		tag: '仙',
		skin: 'royal_turtle',
