...
export const CARDS: TeeCard[] = [
	...
	},
	{
		id: 'yuebingshijia',
		name: '饼香世家',
		desc: '每拥有一个独特的「饼」系角色，该 Tee 得分 ×1.26',
		rarity: 'legendary',
		skin: 'cupcakecherry',
		tag: '饼',
	...
	// 5 张同流派时 ×(2^5)=32 → 一秀 (10+20)×32 = 960 > 状元 320。
	{
		id: 'yutuhui',
		name: '兔儿满堂',
		desc: '每拥有一个独特的「兔」系角色：该 Tee 得分 ×1.42；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '兔',
		skin: 'BunnyViVi',
	...
	},
	{
		id: 'guiyuan',
		name: '桂苑',
		desc: '每拥有一个独特的「桂」系角色：该 Tee 得分 ×1.39；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '桂',
	...
	},
	{
		id: 'yuebingfang',
		name: '饼坊',
		desc: '每拥有一个独特的「饼」系角色：该 Tee 得分 ×1.26；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '饼',
		skin: 'buni',
	...
	},
	{
		id: 'dengzhen',
		name: '灯阵',
		desc: '每拥有一个独特的「灯」系角色：该 Tee 得分 ×1.41；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '灯',
		skin: 'glow_axolotl',
	...
	},
	{
		id: 'yuelun',
		name: '月轮',
		desc: '每拥有一个独特的「月」系角色：该 Tee 得分 ×1.36；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '月',
		skin: 'cloud',
	...
	},
	{
		id: 'xianlv',
		name: '仙侣',
		desc: '每拥有一个独特的「仙」系角色：该 Tee 得分 ×1.41；每有 1 颗 4 点，基础分 +150',
		rarity: 'rare',
		tag: '仙',
	...
	},
	{
		id: 'yutulinfan',
		name: '玉兔临凡',
		desc: '每拥有一个独特的「兔」系角色：所有「兔」系 Tee 得分 ×1.42；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '兔',
		skin: 'usagi',
	...
	},
	{
		id: 'guidian',
		name: '桂殿',
		desc: '每拥有一个独特的「桂」系角色：所有「桂」系 Tee 得分 ×1.39；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '桂',
	...
	},
	{
		id: 'tuanyuanbing',
		name: '团圆饼',
		desc: '每拥有一个独特的「饼」系角色：所有「饼」系 Tee 得分 ×1.26；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '饼',
		skin: 'Mint Choco',
	...
	},
	{
		id: 'changmingdeng',
		name: '长明灯',
		desc: '每拥有一个独特的「灯」系角色：所有「灯」系 Tee 得分 ×1.41；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '灯',
		skin: 'glow_cammo',
	...
	},
	{
		id: 'taiyin',
		name: '太阴素月',
		desc: '每拥有一个独特的「月」系角色：所有「月」系 Tee 得分 ×1.36；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '月',
		skin: 'IceWitch_Queen',
	...
	},
	{
		id: 'qunxianhui',
		name: '群仙会',
		desc: '每拥有一个独特的「仙」系角色：所有「仙」系 Tee 得分 ×1.41；每有 1 颗 4 点，基础分 +300',
		rarity: 'legendary',
		tag: '仙',
		skin: 'Drag Queen',
	...
	},
	{
		id: 'dazhanggui',
		name: '饼铺掌柜',
		desc: '每累计卖出 1 个 Tee：该 Tee 基础分 +75；队伍里没有「我」时，回合结算队伍总分得分 ×2.5',
		rarity: 'legendary',
		tag: '饼',
		skin: 'biscuit',
		effect: {
