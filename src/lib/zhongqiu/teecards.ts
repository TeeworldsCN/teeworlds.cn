...
export const CARDS: TeeCard[] = [
	...
	},
	{
		id: 'lianzhudengzhao',
		name: '连珠灯照',
		desc: '「连珠灯照」在队伍中时：「高照」「串珠」「七星灯」「连珠灯」「连珠灯照」这条线上，每只 Tee 首次投掷的骰子由上一只线上 Tee 的最终骰子状态决定；本关每多掷出 1 个对堂，全队总分 ×2',
		rarity: 'legendary',
		tag: '灯',
		skin: 'glow chinese',
		effect: {
	...
	},
	{
		id: 'lingyue',
		name: '零月',
		desc: '「亏月」「缺月」「残月」掷出四进、五子登科、六博黑时，该等级的基础分记成负数；本关这三张已经结算的得分，按「亏月 ×3 + 缺月 ×2 + 残月」加总，作为「零月」自己的基础分，团队结算时计算该 Tee 得分倍率',
		rarity: 'legendary',
		tag: '月',
		skin: 'dark_chao',
		effect: {
