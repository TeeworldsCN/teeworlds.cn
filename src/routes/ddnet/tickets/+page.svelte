...
<svelte:head>
	<title>服务通知 - TeeworldsCN</title>
	<meta name="description" content="TeeworldsCN 与 DDNet 合作结束通知" />
</svelte:head>
